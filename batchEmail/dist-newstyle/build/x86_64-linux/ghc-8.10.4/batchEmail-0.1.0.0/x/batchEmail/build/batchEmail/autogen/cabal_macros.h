...
/* package batchEmail-0.1.0.0 */
#ifndef VERSION_batchEmail
#define VERSION_batchEmail "0.1.0.0"
#endif /* VERSION_batchEmail */
#ifndef MIN_VERSION_batchEmail
#define MIN_VERSION_batchEmail(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_batchEmail */
/* package async-2.2.3 */
...
#define CURRENT_COMPONENT_ID "batchEmail-0.1.0.0-inplace-batchEmail"

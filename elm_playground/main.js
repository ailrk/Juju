...
var $author$project$State$init = F3(
	function (_v0, _v1, _v2) {
		return _Utils_Tuple2(
			{msg: '', num: 0, sinks: _List_Nil, sources: _List_Nil},
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Path finding')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$State$init, onUrlChange: $author$project$Types$UrlChanged, onUrlRequest: $author$project$Types$LinkClicked, subscriptions: $author$project$State$subscriptions, update: $author$project$State$update, view: $author$project$View$view});
